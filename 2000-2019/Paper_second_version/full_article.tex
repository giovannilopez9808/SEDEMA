...
measurements during the period 2000-2019 was analyzed. ~\selectlanguage{english}
\begin{table}[H]
  \centering
  \begin{tabular}{ccccc}
    \hline
...
sizes~\(\le\) 10 ~\selectlanguage{greek}µ\selectlanguage{english}m (PM\textsubscript{10}), were downloaded
...
concentration is reported in \selectlanguage{greek}µ\selectlanguage{english}g m\textsuperscript{-3} at local
...
While the early OMI estimates of the UVI did not consider aerosols in the boundary layer, Arola et al.\cite{Arola_2009} suggested correcting the clean-skies UV index with a reduction factor based on a monthly global climatology of BL aerosols. For Mexico City a reduction of about 8\% is applied, starting ca. 2013, to the OMI UVI data.

\subsection*{TUV model}

Calculations of the UV Index were also made with the Tropospheric
Ultraviolet Visible (TUV v5.3) model.\cite{Madronich_1987} The
...
(BL).\cite{Shaw_2007} The ozone profile above the BL is from the US
...
profiles of gases \cite{Velasco_2008,Greenberg_2009} and aerosols\cite{Rogers_2009,Lewandowski_2010} by
late morning. The UV-absorbing gases considered here are
O\textsubscript{3}, NO\textsubscript{2}, and SO\textsubscript{2},
specified in ppb.
...
higher values of the UVI, in agreement with the observations.\selectlanguage{english}
\begin{figure}[H]
  \begin{center}
...
the city.\selectlanguage{english}
\begin{figure}[H]
  \begin{center}
...
for Mexico City. ~\selectlanguage{english}
\begin{figure}[H]
  \begin{center}
...
emission reduction policies and programs.\selectlanguage{english}
\begin{figure}[H]
  \begin{center}
...
relative to the TUV values of 15.6 for a pristine atmosphere.\selectlanguage{english}
\begin{table}[H]
  \centering
  \begin{tabular}{lc}
    \hline
  ...
  \end{tabular}
  \caption{{UV Index estimates for June-July.TUV model calculation illustrating the effect of pollutants on the UV Index in Mexico City. The contribution of each pollutant is evaluated by subtraction from the full mixture, rather than individual additions to clean air, to represent more faithfully the interaction between scattering and absorption, e.g. scattering-induced changes in photon path lengths through absorbing gases.}}
...
O\textsubscript{3} and NO\textsubscript{2}.\selectlanguage{english}
...
term variations in these photolysis coefficients.\selectlanguage{english}
\begin{figure}[H]
  \begin{center}
...
\bibliography{bibliography/biblio_url}
\end{document}
